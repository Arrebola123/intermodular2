...
<main>
    <?php if($producto): ?> 
        ...
        <div class="product-detail">
            <img class="productos" src="<?= '../' . $producto->imagen1; ?>" alt="<?= $producto->nombre; ?>">
            <div class="product-info">
                ...
                <div class="checkout"> <button type="submit" onclick="window.location.href='añadir_al_carrito.php?id=<?= $producto->id;?>'">AÑADIR AL CARRITO</button> </div>
            </div>
        </div> 
    <?php else: ?> 
